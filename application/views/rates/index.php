    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createRates', $user_permission)) : ?>
          <a href="<?php echo base_url('rates/create') ?>" class="btn btn-success"> <i class="fa fa-plus"></i></a>
          <br /> <br />
        <?php endif; ?>
                    ...
                    <?php if (in_array('updateRates', $user_permission) || in_array('deleteRates', $user_permission)) : ?>
                      <td>
                        <?php if (in_array('updateRates', $user_permission)) : ?>
                          <a href="<?php echo base_url('rates/edit/' . $v['rate_info']['id']) ?>" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></a>
                        <?php endif; ?>
                        <?php if (in_array('deleteRates', $user_permission)) : ?>
                          <a href="<?php echo base_url('rates/delete/' . $v['rate_info']['id']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                        <?php endif; ?>
                      </td>
                    <?php endif; ?>
                  </tr>
